...
| ASK User Interaction | [ask-user-interaction.md](ask-user-interaction.md) | draft cross-page / Main Page pattern | 高信号用户输入请求，默认由 Main Page ASK Dock 承载；语义来源为 [ASK Lifecycle Contract](../engineering/ask-lifecycle-contract.md)。 |
