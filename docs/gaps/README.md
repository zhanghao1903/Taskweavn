...
- context governance beyond the Product 1.0 minimum.
...
| Linear authoring and retry recovery | Authoring / runtime | P0 | planned | [authoring-domain](../architecture/authoring-domain.md), [task](../architecture/task.md), [bus](../architecture/bus.md), [ADR-0010](../decisions/ADR-0010-line-first-authoring-experience-for-1-0.md) | [linear authoring / retry recovery plan](../plans/feature/linear-authoring-retry-recovery.md) | Product 1.0 should default to one active Session, one active work tree, and line-first execution. Minimal manual whole-Task retry and interrupted-running recovery are planned; full context governance remains Product 1.1+. |
