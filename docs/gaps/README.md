...
| Routing Agent assignment productization | Task / agents | P0 | planned | [agent](../architecture/agent.md), [tool-capability-layer](../architecture/tool-capability-layer.md), [task](../architecture/task.md), [bus](../architecture/bus.md), [ADR-0009](../decisions/ADR-0009-routing-agent-assignment-and-cooperative-interruption.md) | TBD | Product 1.0 assignment should be Routing Agent driven: router submits assignment commands, TaskBus records assignment and validates claim, Execution Agent only claims tasks assigned to itself. |
