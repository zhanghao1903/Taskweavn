...
| Cooperative task interruption | Task / agents | P0 | planned | [task](../architecture/task.md), [bus](../architecture/bus.md), [interaction-layer](../architecture/interaction-layer.md), [ADR-0011](../decisions/ADR-0011-routing-agent-assignment-and-cooperative-interruption.md), [ADR-0014](../decisions/ADR-0014-interaction-control-taxonomy-for-product-1-0.md) | [cooperative interruption plan](../plans/feature/cooperative-task-interruption.md), [technical design](../plans/feature/cooperative-task-interruption-technical-design.zh-CN.md) | User/system can request stop; TaskBus records intent, Agent/runtime owns safe points and acknowledges terminal outcome. Pending can stop immediately as failed with a `cancelled:` reason; running remains running and projects as stopping until acknowledged. ADR-0014 classifies interruption as a control intent, so this slice should proceed before the broader Message/ASK/confirmation UI integration. |
| Message, ASK, and confirmation UI integration | Interaction / UI | P0 | in_progress | [interaction-layer](../architecture/interaction-layer.md), [ui-backend-communication](../architecture/ui-backend-communication.md), [task-domain-ui-model-separation](../architecture/task-domain-ui-model-separation.md), [ADR-0014](../decisions/ADR-0014-interaction-control-taxonomy-for-product-1-0.md) | [backend plan](../plans/feature/message-ask-confirmation-backend.md), [technical design](../plans/feature/message-ask-confirmation-backend-technical-design.zh-CN.md), [release](../releases/message-ask-confirmation-backend.md), [UI API interfaces](../plans/ui/ui-api-interfaces.md), [ASK lifecycle contract](../engineering/ask-lifecycle-contract.md), [ASK interaction model](../interaction-model/ask-user-interaction.md) | Product 1.0 backend closure is done: durable ASK store, `ask_user` runtime action/tool, `waiting_for_user` TaskBus pause, answer-before-resume command path, Main Page ASK query/projection, and Context Manager answered ASK facts are in place. Remaining Product 1.0 work is frontend ASK Dock/answer UI, confirmation UI integration/copy cleanup, event/refetch polish, and final QA. Confirmation remains a separate authorization lifecycle. |
