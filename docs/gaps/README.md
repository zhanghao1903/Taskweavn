...
| Fixed-route task execution bridge | Task / agents | P0 | in_progress | [task](../architecture/task.md), [bus](../architecture/bus.md), [agent](../architecture/agent.md), [ADR-0010](../decisions/ADR-0010-line-first-authoring-experience-for-1-0.md) | [fixed-route execution plan](../plans/feature/fixed-route-task-execution-bridge.md), [technical design](../plans/feature/fixed-route-task-execution-bridge-technical-design.zh-CN.md), [checkpoint](../releases/fixed-route-task-execution-bridge.md) | Checkpoint reached: `FixedRouteTaskExecutor`, resident Default Agent protocol, AgentLoop-backed sidecar assembly, one-tick sidecar seam, and Main Page execution projection are in place. Gap remains open for production runtime trigger/background dispatch, durable result payload behavior, and user-facing smoke. No Router, Agent Manager, assignment fields, or Main Page reassignment UI are included. |
