...
| Result and evidence exposure surface | Result / UI / Trust | P0 | planned | [task-domain-ui-model-separation](../architecture/task-domain-ui-model-separation.md), [ui-backend-communication](../architecture/ui-backend-communication.md), [configurable-logging-system](../architecture/configurable-logging-system.md) | [result exposure plan](../plans/feature/result-exposure-surface.md), [Audit page contract](../engineering/audit-page-contract.md), [UI ViewModel contract](../frontend/ui-viewmodel-contract.md) | New Product 1.0 closure gap. Main Page needs user-readable execution result, process messages, file summary, audit entry, and recoverable error summary. Audit/Diagnostics keep raw evidence and logs. Agent summary, deterministic projector summary, and audit verdict are separate responsibilities. |
