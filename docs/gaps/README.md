...
| Routing Agent assignment productization | Task / agents | P0 | planned | [agent](../architecture/agent.md), [tool-capability-layer](../architecture/tool-capability-layer.md), [task](../architecture/task.md), [bus](../architecture/bus.md), [ADR-0009](../decisions/ADR-0009-routing-agent-assignment-and-cooperative-interruption.md), [ADR-0010](../decisions/ADR-0010-taskbus-centered-agent-assignment-convergence.md) | [minimal assignment plan](../plans/feature/minimal-agent-assignment-semantics.md), [technical design](../plans/feature/minimal-agent-assignment-semantics-technical-design.zh-CN.md) | Product 1.0 assignment should be Router driven: Router contains deterministic runtime plus optional Routing Agent policy, TaskBus records assignment and validates claim, Agent Manager creates instances and claims assigned Tasks, and stale pending Tasks degrade through TaskBus sweep. |
| Cooperative task interruption | Task / agents | P0 | planned | [task](../architecture/task.md), [bus](../architecture/bus.md), [interaction-layer](../architecture/interaction-layer.md), [ADR-0009](../decisions/ADR-0009-routing-agent-assignment-and-cooperative-interruption.md) | TBD | User/system can request stop; TaskBus records intent, Agent/runtime owns safe points and acknowledges terminal outcome. Pending can stop immediately; running is cooperative. |
...
| Agent protocol and governance | Agents / extensibility | P1 | unplanned | [agent](../architecture/agent.md), [tool-capability-layer](../architecture/tool-capability-layer.md), [bus](../architecture/bus.md), [ADR-0009](../decisions/ADR-0009-routing-agent-assignment-and-cooperative-interruption.md) | [Product 1.1 plan](../product/plato-1-1-product-plan.md) | Product 1.1 TODO: define the baseline Agent contract, what an Agent must satisfy to join the system, and later special protocols for Routing, Execution, Collaborator, Audit, and Result Packaging Agents. Custom Agent creation and validation are advanced features outside 1.0. |
