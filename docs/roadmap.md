...
3. **Message, ASK, and confirmation UI integration planning/hardening** — after interruption, split durable ASK, answer commands, ASK Dock, event/refetch, and confirmation UI hardening into smaller Product 1.0 slices.
