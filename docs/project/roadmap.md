...
4. Normal browser/Electron smoke and Product 1.0 QA: validate the accepted Main Page, fixed-route bridge, and cache-aware Context Manager path through the intended local runtime shell.
