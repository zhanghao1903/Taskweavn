...
5. Product 1.1 planning: completion-time `task_after`, Result Packaging Agent, Agent protocol/governance, skills integration, MCP integration, and file/multimodal support.
