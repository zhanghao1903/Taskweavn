...
| [ui-backend-contract-baseline.md](ui-backend-contract-baseline.md) | In progress: split and harden Plato UI snapshot/query/command/event/error contracts before sidecar transport. |
