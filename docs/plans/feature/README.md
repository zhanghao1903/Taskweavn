...
| [fixed-route-task-execution-bridge.md](fixed-route-task-execution-bridge.md) | In progress: Product 1.0 fixed-route bridge from TaskBus pending Tasks to resident universal Default Agent execution and complete/fail. |
| [fixed-route-task-execution-bridge-technical-design.zh-CN.md](fixed-route-task-execution-bridge-technical-design.zh-CN.md) | In progress 中文详细技术方案：常驻万能 Default Agent、TaskBus claim_next、complete/fail 和测试设计。 |
