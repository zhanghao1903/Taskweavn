...
| [plato-1-1-product-plan.md](plato-1-1-product-plan.md) | Product 1.1 planning baseline: workspace-aware collaboration, service-capable execution, items moved out of 1.0, skills, MCP, file, and multimodal research themes. |
| [plato-1-1-web-retrieval-beta-limitations.md](plato-1-1-web-retrieval-beta-limitations.md) | Product 1.1 web retrieval beta limitations: opt-in availability, freshness, fetch coverage, evidence UI, cost boundaries, and release copy. |
| [plato-1-1-technical-design.zh-CN.md](plato-1-1-technical-design.zh-CN.md) | Product 1.1 technical design baseline: runtime input, Plan/TaskNode, Execution Plane, context/skills, evidence, QA, sequencing, and open decisions. |
| [plato-1-1-open-work.md](plato-1-1-open-work.md) | Active Product 1.1 open-work index: P0/P1/P2 remaining work, with P0 narrowed to Runtime Input Router, Contract Revision Command Skills, and durable Activity/Audit evidence. |
| [plato-1-1-p1-coverage-audit-2026-06-24.md](plato-1-1-p1-coverage-audit-2026-06-24.md) | Product 1.1 P1 coverage audit mapping each P1 beta-depth row to its owner PR or explicit deferral. |
...
| [remote-wechat-message-task-prd.md](remote-wechat-message-task-prd.md) | Product 1.1+ exploratory PRD for API-triggered remote computer execution of a WeChat message task, including required safety/evidence flow and capability gaps. |
