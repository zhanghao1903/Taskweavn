...
| PUB-VIS-005A | Product overview / user guide | Authoring ASK screenshot: planning questions before TaskTree generation | `exported` | `plato-public` draft PR #1: `assets/screenshots/plato-authoring-ask.svg` | Public PR review | Public-safe screenshot-style SVG based on Product 1.0 Authoring ASK placement rules. |
| PUB-VIS-005B | Product overview / user guide | Execution ASK screenshot: task-scoped question in the detail panel | `exported` | `plato-public` draft PR #1: `assets/screenshots/plato-execution-ask.svg` | Public PR review | Public-safe screenshot-style SVG based on Product 1.0 Execution ASK placement rules. |
