...
This directory keeps public-exposure planning together under the Plato product
docs tree. It is for deciding what can be shown publicly, what needs rewriting
or sanitization, and which visual assets must be produced before public docs are
expanded.
...
| [plato-1-1-public-release-doc-sync.md](plato-1-1-public-release-doc-sync.md) | Product 1.1 formal public release docs sync package: source docs, public targets, allowed/forbidden claims, limitations, and public PR checklist. |
...
Product 1.1 formal release notes are now prepared in
[Product 1.1 Formal Release Notes](../../releases/product-1-1-formal-release-notes.md).
Treat that file plus the Product 1.1 public release docs sync package as the
public-safe source for release-copy and known-limitations sync; the actual
public repository update remains a separate publishing operation.

Do not copy private implementation docs, screenshots, logs, workspaces, or
diagnostics into the public repository until the relevant item is approved by
the exposure plan and visual gap checklist.
