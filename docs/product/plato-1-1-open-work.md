...
| Diagnostics descriptors | Add richer beta-depth diagnostic bundle descriptors for workspace inspection evidence, support-oriented summaries, and the scoped [Electron Route Log Descriptors](../plans/feature/electron-route-log-descriptors.md). | Improves supportability beyond the P0 route-matrix closure. |
