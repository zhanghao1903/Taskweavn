...
It describes the implemented Product 1.1 local runtime, while preserving the
Product 1.0 execution baseline that still anchors task execution.
...
safe classifier and dispatcher, not a workspace tool runner.
...
Manager controls, or assigned-only TaskBus claim semantics.
...
14. [TaskBus](bus.md)
15. [Agent](agent.md)
16. [Tool Capability Layer](tool-capability-layer.md)
17. [Workspace Communication Protocol](workspace-communication-protocol.md)
18. [Context Manager](context-manager.md)
19. [Product 1.1 Open Work](../product/plato-1-1-open-work.md)
20. [Product 1.1 Runtime Input Router Release Evidence](../releases/product-1-1-runtime-input-router-release-evidence.md)
