...
| [multi-workspace-api-runtime-contract.md](multi-workspace-api-runtime-contract.md) | Multi-workspace API/runtime contract: workspaceId-scoped routes, runtime registry, catalog semantics, event/cursor/idempotency boundaries, and compatibility aliases. | Draft contract; implementation not started. |
