  ...
  state({
    ...
    messages: [
      ...baseMessages,
      {
        ...
        body: "This task is read-only right now. Editing and publishing are unavailable.",
    ...
    detail: {
      ...
      body: "You can inspect this task, but changes are unavailable until permissions change.",
    },
    inputScope: {
      label: "Input paused for this task",
      placeholder: "Input will reopen when permissions change.",
    },
    result: null,
    fileChangeSummary: null,
  }),
