...
_LAZY_EXPORTS = {
    ...
    "ComputerUseHelperAppBuildResult": "taskweavn.server.computer_use_helper_app",
    "ComputerUseHelperAppConfig": "taskweavn.server.computer_use_helper_app",
    ...
    "build_computer_use_helper_app": "taskweavn.server.computer_use_helper_app",
